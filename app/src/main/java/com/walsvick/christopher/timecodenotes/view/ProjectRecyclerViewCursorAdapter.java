...
public class ProjectRecyclerViewCursorAdapter extends RecyclerView.Adapter<ProjectRecyclerViewCursorAdapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnCreateContextMenuListener {
        ...
        public void onCreateContextMenu(ContextMenu contextMenu, View view, ContextMenu.ContextMenuInfo contextMenuInfo) {
            ...
            contextMenu.add(Menu.NONE, R.id.menu_item_email_project, Menu.NONE, R.string.export_and_share);
           // contextMenu.add(Menu.NONE, R.id.menu_item_export_project, Menu.NONE, R.string.export_to_device);
        }
    }
